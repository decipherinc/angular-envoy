...
(function (global){
"use strict";function envoyFactory(e,r){function n(t){var o;return(o=n._cache[t.$name])?r.when(o):e.get(opts.dataFile,{cache:!0}).then(function(e){var r=e.data;return t&&(r=_(r[t.$alias||t.$name]).mapValues(function(e,r){var o=t[r],a=o&&_.size(o.$error);return o&&a?_(e).pick(_.keys(o.$error)).each(function(e){e.action=n.getAction(t.$name,r)}).value():void 0}).pick(_.identity).value()),n._cache[t.$name]=r,r})}var t,o=_.pluck(opts.levels,"name"),a=_(o).invert().mapValues(_.parseInt).value(),i={},u={};return t={_cache:{},level:function(e){return _.isString(e)?a[e]||a[opts.defaultLevel]:o[e]||opts.defaultLevel},formErrorLevel:function(e){if(!e)throw new Error("parameter is required");return n(e).then(function(r){return n._formErrorLevel(e,r)})},_formErrorLevel:function(e,r){var t=a[opts.defaultLevel],i=_.reduce(r,function(r,t){var o=_(t).pick(function(r,n){return e.$error[n]}).pluck("level").map(n.level).max();return Math.max(r,o)},t);return debug('Computed errorLevel "%s" for form "%s"',n.level(i),e.$name),o[i]},_lastControl:null,_lastControlError:null,_emitting:null,bindForm:function(e,r){if(u[r.$name])throw new Error('Form "'+r.$name+'" already bound!  One envoyMessages directive per form, please.');u[r.$name]=e},emit:function l(e,t){function i(e,r){return r=r||[e],e.$parent?(r.push(e.$parent),i(e.$parent,r)):r}function c(e,r){return r=r||[],e.$children.length?(r.push.apply(r,e.$children),_.map(e.$children,function(e){return c(e,r)})):_(r).flatten().unique().value()}var l=_.debounce(function(){var l=u[e.$name],f=i(l),m=c(l),s=_.unique(f.concat(m));debug('Emitting from form "%s"; "%s" changed',e.$name,t.$name),n._emitting=r.all(_.map(s,function(e){return n(e.$form)})).then(function(r){var i=a[opts.defaultLevel],u={},l=_.reduce(r,function(e,r,t){var o=s[t].$form,i=n._formErrorLevel(o,r),l=a[i];return o.$errorLevel=l,u[o.$name]=r,_.isNumber(l)?Math.max(e,l):e},i);e.$formScope.$emit("$formStateChanged",{errorLevel:l,errorLevelName:o[l],messages:_.omit(u,_.isEmpty),control:t}),n._lastControl=t,n._lastControlError=_.keys(t.$error)})},BROADCAST_DEBOUNCE_MS);return delete n._cache[e.$name],n._emitting?n._emitting.then(l.bind(null,e,t)):r.when(l())},setAction:function(e,r,n){var t=i[e]=i[e]||{};t[r]=n},getAction:function(e,r){return _.get(i,_.format("%s.%s",e,r))},findParentCtrl:function(e,r){for(;r.$name!==e;)if(r=r.$parent,!r)throw new Error("cannot find parent with name "+e);return r},levelDescription:function(e){var r;return(r=n.LEVELS[e])&&r.description},DEFAULT_LEVEL:opts.defaultLevel,ERRORLEVELS:a,LEVELS:opts.levels,opts:opts},_.extend(n,t),n}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,opts=require("./opts"),BROADCAST_DEBOUNCE_MS=250,debug=require("debug")("envoy:$envoy:factory");envoyFactory.$inject=["$http","$q"],module.exports=envoyFactory;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
