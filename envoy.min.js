...
(function (global){
"use strict";function envoyFactory(e,r){function n(t){var o;return(o=n._cache[t.$name])?r.when(o):e.get(opts.dataFile,{cache:!0}).then(function(e){var r=e.data;return t&&(r=_(r[t.$alias||t.$name]).mapValues(function(e,r){var o=t[r],a=o&&_.size(o.$error);return o&&a?_(e).pick(_.keys(o.$error)).each(function(e){e.action=n.getAction(t.$name,r)}).value():void 0}).pick(_.identity).value()),n._cache[t.$name]=r,r})}var t,o=_.pluck(opts.levels,"name"),a=_(o).invert().mapValues(_.parseInt).value(),u={};return t={_cache:{},level:function(e){return _.isString(e)?a[e]||a[opts.defaultLevel]:o[e]||opts.defaultLevel},formErrorLevel:function(e){if(!e)throw new Error("parameter is required");return n(e).then(function(r){return n._formErrorLevel(e,r)})},_formErrorLevel:function(e,r){var t=a[opts.defaultLevel],u=_.reduce(r,function(r,t){var o=_(t).pick(function(r,n){return e.$error[n]}).pluck("level").map(n.level).max();return Math.max(r,o)},t);return o[u]},_lastControl:null,_lastControlError:null,$broadcast:function(e,t){var u=e,l=null,i=_.debounce(function(){var i=[u];for(debug('Broadcasting from form "%s"; "%s" changed',e.$name,t.$name),i.unshift(u);u.$$parentForm&&u.$$parentForm.$name;)u=u.$$parentForm,i.unshift(u);l=r.all(_.map(i,n)).then(function(e){var r=a[opts.defaultLevel],l={},c=_.reduce(e,function(e,r,t){var o=i[t],u=n._formErrorLevel(o,r),c=a[u];return o.$errorLevel=c,l[o.$name]=r,_.isNumber(c)?Math.max(e,c):e},r);u.$formScope.$broadcast("$formStateChanged",{errorLevel:c,errorLevelName:o[c],messages:_.omit(l,_.isEmpty),forms:i,control:t}),n._lastControl=t,n._lastControlError=_.keys(t.$error)})},BROADCAST_DEBOUNCE_MS);return delete n._cache[e.$name],l?l.then(n.$broadcast.bind(null,e,t)):r.when(i())},setAction:function(e,r,n){var t=u[e]=u[e]||{};t[r]=n},getAction:function(e,r){return _.get(u,_.format("%s.%s",e,r))},findParentCtrl:function(e,r){for(;r.$name!==e;)if(r=r.$parent,!r)throw new Error("cannot find parent with name "+e);return r},levelDescription:function(e){var r;return(r=n.LEVELS[e])&&r.description},DEFAULT_LEVEL:opts.defaultLevel,ERRORLEVELS:a,LEVELS:opts.levels,opts:opts},_.extend(n,t),n}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,opts=require("./opts"),BROADCAST_DEBOUNCE_MS=250,debug=require("debug")("envoy:envoy:factory");envoyFactory.$inject=["$http","$q"],module.exports=envoyFactory;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
