...
"use strict";function list(e,t){return{restrict:"EA",scope:!0,require:"?^envoyMessages",templateUrl:opts.templateUrl,link:function(r,n,i,o){var s,a=i.envoyList||i["for"];if(a)s=e.findParentCtrl(t(a)(r));else{if(!o)throw new Error("envoyList requires an ancestor envoyMessages directive or a form name");s=o}s.bindView(r),r.$on("$destroy",function(){s.unbindView()})}}}var opts=require("../envoy/opts");list.$inject=["$envoy","$interpolate"],module.exports=list;
...
(function (global){
"use strict";function MessagesCtrl(e,t,i,s,n){var r;this.bindView=function(e){if(r.scope)throw new Error("view already bound!");return r.scope=e,e.data=viewData(t.DEFAULT_LEVEL),debug("View bound"),this},this.update=function(e){var i,s=this.$viewData;return s?(debug('"%s" updating with new data:',this.$name,e),this.$errorLevel=i=_.isNumber(e.errorLevel)?e.errorLevel:this.$errorLevel,_.each(e.messages,function(e,t){s.messages[t]?_.each(e,function(e,i){_.isObject(e)?s.messages[t][i]?_.extend(s.messages[t][i],e):s.messages[t][i]=e:delete s.messages[t][i]}):s.messages[t]=e}),s.error=!!i,s.className=t.level(i),s.title=this.title(i),debug('"%s" updated; view data:',this.$name,s),s):void 0},this.unbindView=function(){return delete r.scope,r=null,debug("View unbound"),this},this.addChild=function(e){return debug('Adding child "%s" to "%s"',e.$name,this.$name),this.$children.push(e),e.$parent=this,this},this.removeChild=function(e){return debug('Removing child "%s" from "%s"',e.$name,this.$name),this.$children.splice(this.$children.indexOf(e),1),delete e.$parent,this},this.title=function(e){return t.levelDescription(e)},this.toString=function(){return this.$name},this.broadcast=s.$broadcast.bind(s),this.emit=s.$parent.$emit.bind(s.$parent),function(){var i;this.$children=[],this.$parent=null,this.$errorLevel=t.DEFAULT_ERRORLEVEL,Object.defineProperties(this,{$errorLevel:{get:function(){return i.$errorLevel},set:function(e){i.$errorLevel=e}},$name:{get:function(){return i.$name}},$viewData:{get:function(){var e;return(e=_.get(r,"scope.data"))?e:r.scope?r.scope.data=viewData(t.DEFAULT_LEVEL):void 0},set:function(e){r.scope.data=e}}}),i=this.$form=e.controller("form"),this.$children=[],r=this.$parent?this.$view=this.$parent.$view:this.$view={},s.$on("$destroy",t.bindForm(this,this.$name))}.call(this)}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,viewData=require("./viewdata"),debug=require("debug")("envoy:directives:messages:controller");MessagesCtrl.$inject=["$element","$envoy","$attrs","$scope","$interpolate"],module.exports=MessagesCtrl;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./viewdata":8,"debug":15}],7:[function(require,module,exports){
"use strict";function messages(e,r){return{restrict:"AE",require:"envoyMessages",controller:require("./messages-ctrl"),scope:!0,link:function(t,n,s,o){var i;s.parent&&(i=e(s.parent)(t))&&(r.findParentCtrl(i,n.parent().controller("envoyMessages")).addChild(o),o.$parent.$form===o.$form&&(o.$parent.removeChild(o),debug("Attempted to initialize %s with its own parent",o.$form.$name))),t.$on("$destroy",function(){o.$parent&&o.$parent.removeChild(o)})}}}var debug=require("debug")("envoy:directives:messages");messages.$inject=["$interpolate","$envoy"],module.exports=messages;
...
"use strict";var DEFAULT_LEVELS=[{name:"ok",description:"Fixed!"},{name:"warning",description:"Warning"},{name:"error",description:"Error"}],DEFAULT_DATA_FILE="messages.json",DEFAULT_LEVEL="ok";module.exports={levels:DEFAULT_LEVELS,defaultLevel:DEFAULT_LEVEL,dataFileUrl:DEFAULT_DATA_FILE,templateUrl:"partials/messages.html"};
...
(function (global){
"use strict";function config(e){e.decorator("ngFormDirective",formDecorator),debug("%s v%s ready",pkg.name,pkg.version)}var angular="undefined"!=typeof window?window.angular:"undefined"!=typeof global?global.angular:null,_="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,directives=require("./directives"),pkg=require("../package.json"),formDecorator=require("./form-decorator"),$envoy=require("./envoy"),MODULE_NAME="fv.envoy",debug=require("debug")("envoy"),envoy;config.$inject=["$provide"],envoy=angular.module(MODULE_NAME,[]).config(config).provider("$envoy",$envoy),_.each(directives,function(e,o){envoy.directive(o,e)}),module.exports=envoy;
...
module.exports={"name":"angular-envoy","version":"0.0.1","description":"Highly flexible form validation messaging for AngularJS","main":"index.js","author":"Christopher Hiller <chiller@focusvision.com>","license":"MIT","repository":{"type":"git","url":"https://github.com/decipherinc/angular-envoy.git"},"devDependencies":{"angular":"^1.4.1","browserify":"^10.2.4","chai":"^3.0.0","exposify":"^0.4.3","grunt":"^0.4.5","grunt-bower-install-simple":"^1.1.3","grunt-browserify":"^3.8.0","grunt-bump":"^0.3.1","grunt-cli":"^0.1.13","grunt-contrib-clean":"^0.6.0","grunt-contrib-copy":"^0.8.0","grunt-dev-update":"^1.3.0","grunt-eslint":"^15.0.0","grunt-gh-pages":"^0.10.0","grunt-mocha-istanbul":"^2.4.0","grunt-ngdocs":"^0.2.7","istanbul":"^0.3.17","jit-grunt":"^0.9.1","jsonminifyify":"^0.1.1","load-grunt-config":"^0.17.1","mocha":"^2.2.5","time-grunt":"^1.2.1","uglifyify":"^3.0.1"},"scripts":{"test":"grunt test"},"peerDependencies":{"angular":"^1.4.1"},"dependencies":{"debug":"^2.2.0","lodash":"^3.9.3"}}
},{}]},{},[1]);
