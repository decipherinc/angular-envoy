...
(function (global){
"use strict";function MessagesCtrl(e,t,i,r,n){var s;this.bindView=function(e){if(s.scope)throw new Error("view already bound!");return s.scope=e,e.data=viewData(t.DEFAULT_LEVEL),this},this.update=function(e){var t,i=this.$viewData;i&&(t=e.errorLevel,i.messages=e.messages,i.error=!!t,i.className=e.errorLevelName,i.title=this.title(t),debug('envoyMessages directive for form "%s" received $formStateChanged event; view data:',this.$name,i))},this.unbindView=function(){return delete s.scope,this},this.addChild=function(e){return this.$children=(this.$children||[]).push(e),e.$parent=this,this},this.removeChild=function(e){return this.$children.splice(this.$children.indexOf(e),1),delete e.$parent,this},this.title=function(e){return t.levelDescription(e)},function(){var a,o;this.$children=[],this.$parent=null,Object.defineProperties(this,{$errorLevel:{get:function(){return o.$errorLevel},set:function(e){o.$errorLevel=e}},$name:{get:function(){return o.$name}},$viewData:{get:function(){var e;return(e=_.get(s,"scope.data"))?e:_.get(s,"scope")?s.scope.data=viewData(t.DEFAULT_LEVEL):void 0},set:function(e){s.scope.data=e}}}),o=this.$form=e.controller("form"),i.parent&&(a=n(i.parent)(r))&&(t.findParentCtrl(a,e.parent().controller("envoyMessages")).addChild(this),this.$parent.$form===o&&this.$parent.removeChild(this)),s=this.$parent?this.$view=this.$parent.$view:this.$view={},this.$scope=r,t.bindForm(this,this.$form)}.call(this)}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,viewData=require("./viewdata"),debug=require("debug")("envoy:directives:messages:controller");MessagesCtrl.$inject=["$element","$envoy","$attrs","$scope","$interpolate"],module.exports=MessagesCtrl;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./viewdata":8,"debug":15}],7:[function(require,module,exports){
"use strict";function messages(){return{restrict:"AE",require:"envoyMessages",controller:require("./messages-ctrl"),scope:!0,link:function(e,s,r,n){e.$on("$formStateChanged",function(e,s){n.update(s)}),e.$on("$destroy",function(){n.$parent.removeChild(n)})}}}var debug=require("debug")("envoy:directives:messages");messages.$inject=["$envoy"],module.exports=messages;
...
(function (global){
"use strict";function proxy(e){var r="proxy";return{restrict:"A",require:"ngModel",link:function(o,n,l,t){var a;(a=l.envoyProxy)&&(n.addClass("errorlevel"),o.$on("$formStateChanged",function(o,l){var a;_.each(e.ERRORLEVELS,function(e,r){n.removeClass(r)}),a=l.errorLevel,t.$setValidity(r,a),a&&n.addClass(l.errorLevelName)}))}}}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null;proxy.$inject=["$envoy"],module.exports=proxy;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{}],10:[function(require,module,exports){
(function (global){
"use strict";function envoyFactory(e,n){function r(t){var o;return(o=r._cache[t.$name])?n.when(o):e.get(opts.dataFile,{cache:!0}).then(function(e){var n=e.data;return t&&(n=_(n[t.$alias||t.$name]).mapValues(function(e,n){var o=t[n],a=o&&_.size(o.$error);return o&&a?_(e).pick(_.keys(o.$error)).each(function(e){e.action=r.getAction(t.$name,n)}).value():void 0}).pick(_.identity).value()),r._cache[t.$name]=n,n})}var t,o=_.pluck(opts.levels,"name"),a=_(o).invert().mapValues(_.parseInt).value(),u={},i={};return t={_cache:{},level:function(e){return _.isString(e)?a[e]||a[opts.defaultLevel]:o[e]||opts.defaultLevel},formErrorLevel:function(e){if(!e)throw new Error("parameter is required");return r(e).then(function(n){return r._formErrorLevel(e,n)})},_formErrorLevel:function(e,n){var t=a[opts.defaultLevel],u=_.reduce(n,function(n,t){var o=_(t).pick(function(n,r){return e.$error[r]}).pluck("level").map(r.level).max();return Math.max(n,o)},t);return debug('Computed errorLevel "%s" for form "%s"',r.level(u),e.$name),o[u]},_emitting:null,bindForm:function(e,n){if(i[n.$name])throw new Error('Form "'+n.$name+'" already bound!  One envoyMessages directive per form, please.');i[n.$name]=e},emit:function c(e,t){function u(e,n){return n=n||[e],e.$parent?(n.push(e.$parent),u(e.$parent,n)):n}function l(e,n){return n=n||[],e.$children.length?(n.push.apply(n,e.$children),_.map(e.$children,function(e){return l(e,n)})):_(n).flatten().unique().value()}function f(e){return n.all(_.map(e,function(e){return r(e.$form)})).then(function(n){var t=a[opts.defaultLevel],u={},i=_.reduce(n,function(n,t,o){var i=e[o].$form,c=r._formErrorLevel(i,t),l=a[c];return i.$errorLevel=l,u[i.$name]=t,_.isNumber(l)?Math.max(n,l):n},t);return{errorLevel:i,errorLevelName:o[i],messages:_.omit(u,_.isEmpty)}})}var c=_.debounce(function(){var o=i[e.$name],a=u(o),c=l(o);debug('Emitting from form "%s"; "%s" changed',e.$name,t.$name),c.unshift(o),r._emitting=n.all([f(a),f(c),f([o])]).then(function(e){var n=e[0],r=e[1],t=e[2];o.$scope.$parent.$emit("$formStateChanged",n),_(o.$children).pluck("$scope").unique().each(function(e){e.$broadcast("$formStateChanged",r)}),o.update(t)})},BROADCAST_DEBOUNCE_MS);return delete r._cache[e.$name],r._emitting?r._emitting.then(c.bind(null,e,t)):n.when(c())},setAction:function(e,n,r){var t=u[e]=u[e]||{};t[n]=r},getAction:function(e,n){return _.get(u,_.format("%s.%s",e,n))},findParentCtrl:function(e,n){for(;n.$name!==e;)if(n=n.$parent,!n)throw new Error("cannot find parent with name "+e);return n},levelDescription:function(e){var n;return(n=r.LEVELS[e])&&n.description},DEFAULT_LEVEL:opts.defaultLevel,ERRORLEVELS:a,LEVELS:opts.levels,opts:opts},_.extend(r,t),r}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,opts=require("./opts"),BROADCAST_DEBOUNCE_MS=250,debug=require("debug")("envoy:$envoy:factory");envoyFactory.$inject=["$http","$q"],module.exports=envoyFactory;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
