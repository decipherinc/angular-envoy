...
(function (global){
"use strict";function envoyFactory(e,r){function n(t){var o;return(o=n._cache[t.$name])?r.when(o):e.get(opts.dataFile,{cache:!0}).then(function(e){var r=e.data;return t&&(r=_(r[t.$alias||t.$name]).mapValues(function(e,r){var o=t[r],a=o&&_.size(o.$error);return o&&a?_(e).pick(_.keys(o.$error)).each(function(e){e.action=n.getAction(t.$name,r)}).value():void 0}).pick(_.identity).value()),n._cache[t.$name]=r,r})}var t,o=_.pluck(opts.levels,"name"),a=_(o).invert().mapValues(_.parseInt).value(),l={};return t={_cache:{},level:function(e){return _.isString(e)?a[e]||a[opts.defaultLevel]:o[e]||opts.defaultLevel},formErrorLevel:function(e){if(!e)throw new Error("parameter is required");return n(e).then(function(r){return n._formErrorLevel(e,r)})},_formErrorLevel:function(e,r){var t=a[opts.defaultLevel],l=_.reduce(r,function(r,t){var o=_(t).pick(function(r,n){return e.$error[n]}).pluck("level").map(n.level).max();return Math.max(r,o)},t);return debug('Computed errorLevel "%s" for form "%s"',n.level(l),e.$name),o[l]},_lastControl:null,_lastControlError:null,_broadcasting:null,$broadcast:function(e,t){var l=e,u=_.debounce(function(){var u=[l];for(debug('Broadcasting from form "%s"; "%s" changed',e.$name,t.$name);l.$$parentForm&&l.$$parentForm.$name;)l=l.$$parentForm,u.unshift(l);n._broadcasting=r.all(_.map(u,n)).then(function(e){var r=a[opts.defaultLevel],i={},c=_.reduce(e,function(e,r,t){var o=u[t],l=n._formErrorLevel(o,r),c=a[l];return o.$errorLevel=c,i[o.$name]=r,_.isNumber(c)?Math.max(e,c):e},r);l.$formScope.$broadcast("$formStateChanged",{errorLevel:c,errorLevelName:o[c],messages:_.omit(i,_.isEmpty),forms:u,control:t}),n._lastControl=t,n._lastControlError=_.keys(t.$error)})},BROADCAST_DEBOUNCE_MS);return delete n._cache[e.$name],n._broadcasting?n._broadcasting.then(n.$broadcast.bind(null,e,t)):r.when(u())},setAction:function(e,r,n){var t=l[e]=l[e]||{};t[r]=n},getAction:function(e,r){return _.get(l,_.format("%s.%s",e,r))},findParentCtrl:function(e,r){for(;r.$name!==e;)if(r=r.$parent,!r)throw new Error("cannot find parent with name "+e);return r},levelDescription:function(e){var r;return(r=n.LEVELS[e])&&r.description},DEFAULT_LEVEL:opts.defaultLevel,ERRORLEVELS:a,LEVELS:opts.levels,opts:opts},_.extend(n,t),n}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,opts=require("./opts"),BROADCAST_DEBOUNCE_MS=250,debug=require("debug")("envoy:$envoy:factory");envoyFactory.$inject=["$http","$q"],module.exports=envoyFactory;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
