...
(function (global){
"use strict";function MessagesCtrl(e,t,i,n,r){var s;this.bindView=function(e){if(s.scope)throw new Error("view already bound!");return s.scope=e,e.data=viewData(t.DEFAULT_LEVEL),this},this.unbindView=function(){return delete s.scope,this},this.addChild=function(e){return this.$children=(this.$children||[]).push(e),e.$parent=this,this},this.removeChild=function(e){return this.$children.splice(this.$children.indexOf(e),1),delete e.$parent,this},this.title=function(e){return t.levelDescription(e)},function(){var o,a;this.$children=[],this.$parent=null,Object.defineProperties(this,{$errorLevel:{get:function(){return a.$errorLevel},set:function(e){a.$errorLevel=e}},$name:{get:function(){return a.$name}},$viewData:{get:function(){var e;return(e=_.get(s,"scope.data"))?e:_.get(s,"scope")?s.scope.data=viewData(t.DEFAULT_LEVEL):void 0},set:function(e){s.scope.data=e}}}),a=this.$form=e.controller("form"),i.parent&&(o=r(i.parent)(n))&&(t.findParentCtrl(o,e.parent().controller("envoyMessages")).addChild(this),this.$parent.$form===a&&this.$parent.removeChild(this)),s=this.$parent?this.$view=this.$parent.$view:this.$view={},this.$scope=n,t.bindForm(this,this.$form)}.call(this)}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,viewData=require("./viewdata");MessagesCtrl.$inject=["$element","$envoy","$attrs","$scope","$interpolate"],module.exports=MessagesCtrl;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./viewdata":8}],7:[function(require,module,exports){
"use strict";function messages(){return{restrict:"AE",require:"envoyMessages",controller:require("./messages-ctrl"),scope:!0,link:function(e,s,r,t){e.$on("$formStateChanged",function(e,s){var r,a=t.$viewData;a&&(r=s.errorLevel,a.messages=s.messages,a.error=!!r,a.className=s.errorLevelName,a.title=t.title(r),debug('envoyMessages directive for form "%s" received $formStateChanged event; view data:',t.$name,a))}),e.$on("$destroy",function(){t.$parent.removeChild(t)})}}}var debug=require("debug")("envoy:directives:messages");messages.$inject=["$envoy"],module.exports=messages;
...
(function (global){
"use strict";function envoyFactory(e,n){function r(t){var o;return(o=r._cache[t.$name])?n.when(o):e.get(opts.dataFile,{cache:!0}).then(function(e){var n=e.data;return t&&(n=_(n[t.$alias||t.$name]).mapValues(function(e,n){var o=t[n],a=o&&_.size(o.$error);return o&&a?_(e).pick(_.keys(o.$error)).each(function(e){e.action=r.getAction(t.$name,n)}).value():void 0}).pick(_.identity).value()),r._cache[t.$name]=n,n})}var t,o=_.pluck(opts.levels,"name"),a=_(o).invert().mapValues(_.parseInt).value(),i={},u={};return t={_cache:{},level:function(e){return _.isString(e)?a[e]||a[opts.defaultLevel]:o[e]||opts.defaultLevel},formErrorLevel:function(e){if(!e)throw new Error("parameter is required");return r(e).then(function(n){return r._formErrorLevel(e,n)})},_formErrorLevel:function(e,n){var t=a[opts.defaultLevel],i=_.reduce(n,function(n,t){var o=_(t).pick(function(n,r){return e.$error[r]}).pluck("level").map(r.level).max();return Math.max(n,o)},t);return debug('Computed errorLevel "%s" for form "%s"',r.level(i),e.$name),o[i]},_emitting:null,bindForm:function(e,n){if(u[n.$name])throw new Error('Form "'+n.$name+'" already bound!  One envoyMessages directive per form, please.');u[n.$name]=e},emit:function l(e,t){function i(e,n){return n=n||[],e.$parent?(n.push(e.$parent),i(e.$parent,n)):n}function c(e,n){return n=n||[],e.$children.length?(n.push.apply(n,e.$children),_.map(e.$children,function(e){return c(e,n)})):_(n).flatten().unique().value()}function f(e){return n.all(_.map(e,function(e){return r(e.$form)})).then(function(n){var t=a[opts.defaultLevel],i={},u=_.reduce(n,function(n,t,o){var u=e[o].$form,l=r._formErrorLevel(u,t),c=a[l];return u.$errorLevel=c,i[u.$name]=t,_.isNumber(c)?Math.max(n,c):n},t);return{errorLevel:u,errorLevelName:o[u],messages:_.omit(i,_.isEmpty)}})}var l=_.debounce(function(){var o=u[e.$name],a=i(o),l=c(o);debug('Emitting from form "%s"; "%s" changed',e.$name,t.$name),l.unshift(o),r._emitting=n.all([f(a),f(l)]).then(function(e){var n=e[0],r=e[1];o.$scope.$parent.$emit("$formStateChanged",n),o.$scope.$broadcast("$formStateChanged",r)})},BROADCAST_DEBOUNCE_MS);return delete r._cache[e.$name],r._emitting?r._emitting.then(l.bind(null,e,t)):n.when(l())},setAction:function(e,n,r){var t=i[e]=i[e]||{};t[n]=r},getAction:function(e,n){return _.get(i,_.format("%s.%s",e,n))},findParentCtrl:function(e,n){for(;n.$name!==e;)if(n=n.$parent,!n)throw new Error("cannot find parent with name "+e);return n},levelDescription:function(e){var n;return(n=r.LEVELS[e])&&n.description},DEFAULT_LEVEL:opts.defaultLevel,ERRORLEVELS:a,LEVELS:opts.levels,opts:opts},_.extend(r,t),r}var _="undefined"!=typeof window?window._:"undefined"!=typeof global?global._:null,opts=require("./opts"),BROADCAST_DEBOUNCE_MS=250,debug=require("debug")("envoy:$envoy:factory");envoyFactory.$inject=["$http","$q"],module.exports=envoyFactory;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
